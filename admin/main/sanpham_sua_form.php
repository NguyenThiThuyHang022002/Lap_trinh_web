...
if (isset($_GET['MaSP'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($tmpFilePath != "") {
            ...
            $absolutePath = "/Applications/XAMPP/xamppfiles/htdocs/Lap_trinh_web";
        ...
        if ($link) {
            $sql = "UPDATE sanpham SET MaDM='$category', TenSP='$name', HinhAnh='$link',MoTa='$description' where MaSP=$MaSP";
        } else {
            $sql = "UPDATE sanpham SET MaDM='$category', TenSP='$name',MoTa='$description'   where MaSP=$MaSP";
        }
        ...
        $sp_info = mysqli_query($conn, $sql) or die(mysqli_error($conn, $sql));

        $sp_info = mysqli_fetch_assoc($sp_info);
    }
}
    ...
    <div class="container">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Cập nhật sản phẩm</a></li>
        ...
        <div>
            ...
            <div style="text-align:center;margin-bottom:20px">
                <p style="font-weight:bold">Cập nhật sản phẩm</p>
            </div>

            <div style="width:50%;margin-left:25%">
                <form action="index.php?quanly=sua_sp&MaSP=<?php echo$MaSP?>"  enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="name" name="name" value="<?php echo $sp_info['TenSP'] ?>">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="category" name="category">
                            ...
                            ?>
                                <option <?php if ($dm[0] == $sp_info['MaDM']) echo 'selected' ?> value="<?php echo $dm[0] ?>"> <?php echo $dm[1] ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description"><?php echo $sp_info['MoTa']?></textarea>
                    </div>
